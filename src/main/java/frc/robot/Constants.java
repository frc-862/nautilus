...
public class Constants {
        ...
        public static final String TRITON_IDENTIFIER = "/home/lvuser/triton"; // Differentiate between Triton and
                                                                              // Nautlius
        ...
        public static class RobotMotors {
                public static final ThunderBird wristMotor = new ThunderBird(RobotMap.WRIST, RobotMap.CANIVORE_CAN_NAME,
                                WristConstants.INVERTED, WristConstants.STATOR_CURRENT_LIMIT,
                                WristConstants.BRAKE_MODE);
                ...
                public static final ThunderBird algaeCollectorPivotMotor = new ThunderBird(
                                RobotMap.ALGAE_COLLECTOR_PIVOT,
                                RobotMap.CANIVORE_CAN_NAME, AlgaeCollectorConstants.PIVOT_INVERTED,
                                AlgaeCollectorConstants.PIVOT_STATOR_CURRENT_LIMIT,
                                AlgaeCollectorConstants.PIVOT_BRAKE_MODE);
                public static final ThunderBird algaeCollectorRollerMotor = new ThunderBird(
                                RobotMap.ALGAE_COLLECTOR_ROLLER,
                                RobotMap.CANIVORE_CAN_NAME, AlgaeCollectorConstants.ROLLER_INVERTED,
                                AlgaeCollectorConstants.ROLLER_STATOR_CURRENT_LIMIT,
                                AlgaeCollectorConstants.ROLLER_BRAKE_MODE);
                public static final ThunderBird climberMotor = new ThunderBird(RobotMap.CLIMBER,
                                RobotMap.CANIVORE_CAN_NAME,
        ...
        public static class WristConstants {
                ...
                public static final Distance LENGTH = Meters.of(0.18); // TODO: ask mr hurley abt this because i have no
                                                                       // clue
        ...
        public class DrivetrainConstants {
                public static final double MAX_SPEED = TunerConstants.kSpeedAt12Volts.in(MetersPerSecond); // kSpeedAt12Volts
                                                                                                           ...
                                                                                                           // top
                                                                                                           // speed
                public static final double MAX_ANGULAR_RATE = RotationsPerSecond.of(0.75).in(RadiansPerSecond); // 3/4
                                                                                                                // of a
                                                                                                                // rotation
                                                                                                                // per
                                                                                                                // second
                ...
                public class DriveRequests {
                        ...
                        public static Supplier<SwerveRequest> getDrive(DoubleSupplier x, DoubleSupplier y,
                                        DoubleSupplier rot) {
                                return () -> DRIVE
                                                .withVelocityX(y.getAsDouble() * DrivetrainConstants.MAX_SPEED) // Drive
                                                                                                                // forward
                                                                                                                // with
                                                                                                                // negative
                                                                                                                // Y
                                                                                                                // (forward)
                                                .withVelocityY(x.getAsDouble() * DrivetrainConstants.MAX_SPEED) // Drive
                                                                                                                // left
                                                                                                                // with
                                                                                                                // negative
                                                                                                                // X
                                                ...
                                                .withRotationalDeadband(DrivetrainConstants.MAX_ANGULAR_RATE * 0.1) // Add
                                                                                                                    // a
                                                                                                                    // 10%
                                                                                                                    // deadband
                        ...
                        public static SwerveRequest getDrive(double x, double y, double rot) {
                                return DRIVE
                                                .withVelocityX(y * DrivetrainConstants.MAX_SPEED) // Drive forward with
                                                                                                  // negative Y
                                                                                                  // (forward)
                                                .withVelocityY(x * DrivetrainConstants.MAX_SPEED) // Drive left with
                                                                                                  // negative X (left)
                        ...
                        public static Supplier<SwerveRequest> getSlow(DoubleSupplier x, DoubleSupplier y,
                                        DoubleSupplier rot) {
                                return () -> SLOW
                                                ...
                                                .withVelocityY(x.getAsDouble() * DrivetrainConstants.MAX_SPEED
                                                                * SLOW_MODE_MULT) // Drive left
                                                                                  ...
                                                                                  // (left)
                                                .withRotationalRate(rot.getAsDouble()
                                                                * DrivetrainConstants.MAX_ANGULAR_RATE * SLOW_MODE_MULT)
                                                .withDeadband(DrivetrainConstants.MAX_SPEED * 0.1)
                                                .withRotationalDeadband(DrivetrainConstants.MAX_ANGULAR_RATE * 0.1) // Add
                                                                                                                    // a
                                                                                                                    // 10%
        ...
        public static class AutonomousConstants {
                ...
                private static final MomentOfInertia ROBOT_MOI = KilogramSquareMeters.of(5.2268411); // TODO: this
                                                                                                     // assumes even
                                                                                                     // weight
                                                                                                     // distribution;
                                                                                                     // should be
        ...
        public class TunerConstants {
                ...
                public class NautliusTunerConstants {
                        ...
                        private static final TalonFXConfiguration steerInitialConfigs = new TalonFXConfiguration()
                                        .withCurrentLimits(
                                                        new CurrentLimitsConfigs()
                                                                        // Swerve azimuth does not require much torque
                                                                        // output, so we can set a
                                                                        // relatively low
                        ...
                        public static final CANBus kCANBus = new CANBus(RobotMap.CANIVORE_CAN_NAME,
                                        "./logs/example.hoot");
                ...
                public static Swerve createDrivetrain() {
                        return IS_TRITON ? TritonTunerConstants.createDrivetrain()
                                        : NautliusTunerConstants.createDrivetrain();
                }
        }
