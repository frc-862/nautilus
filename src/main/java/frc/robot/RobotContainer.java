...
public class RobotContainer extends LightningContainer {
        ...
        protected void configureButtonBindings() {
                ...
                new Trigger(() -> copilot.getAButton())
                                .whileTrue(new RunCommand(() -> rod.setState(ROD_STATES.L1), rod));
                new Trigger(() -> copilot.getYButton())
                                .whileTrue(new RunCommand(() -> rod.setState(ROD_STATES.L4), rod));

                new Trigger(() -> copilot.getXButton())
                                .whileTrue(new RunCommand(() -> rod.setState(ROD_STATES.L2), rod));
                new Trigger(() -> copilot.getBButton())
                                .whileTrue(new RunCommand(() -> rod.setState(ROD_STATES.L3), rod));
                ...
                // new Trigger(() -> copilot.getAButton()).whileTrue(new InstantCommand(() ->
                // elevator.setPosition(0)));
                // new Trigger(()-> copilot.getYButton()).whileTrue(new InstantCommand(() ->
                // elevator.setPosition(13)));

                // new Trigger(()-> copilot.getXButton()).whileTrue(new InstantCommand(() ->
                // elevator.setPosition(26)));
                // new Trigger(() -> copilot.getBButton()).whileTrue(new InstantCommand(() ->
                // elevator.setPosition(43)));
                ...
                // new Trigger(() -> copilot.getRightBumperButton()).whileTrue(new
                // InstantCommand((() -> wrist.setPosition(-20))));
                // new Trigger(()-> copilot.getLeftBumperButton()).whileTrue(new
                // InstantCommand((() -> wrist.setPosition(-80))));
                // new Trigger(() -> copilot.getStartButton()).onTrue(new InstantCommand(() ->
                ...
                switch (Constants.ROBOT_MODE) {
                        ...
                        default:
                                ...
                                // copilot stuff
                                (new Trigger(copilot::getAButtonPressed))
                                                .whileTrue(new SetRodState(rod, ROD_STATES.L1));
                                (new Trigger(copilot::getBButtonPressed))
                                                .whileTrue(new SetRodState(rod, ROD_STATES.L2));
                                (new Trigger(copilot::getXButtonPressed))
                                                .whileTrue(new SetRodState(rod, ROD_STATES.L3));
                                (new Trigger(copilot::getYButtonPressed))
                                                .whileTrue(new SetRodState(rod, ROD_STATES.L4));
                                ...
                                //biasses
                                new Trigger(() -> copilot.getPOV() == 0).onTrue(rod.addElevatorBias(5));
                                new Trigger(() -> copilot.getPOV() == 180).onTrue(rod.addElevatorBias(-5));
